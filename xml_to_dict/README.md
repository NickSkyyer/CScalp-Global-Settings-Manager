...
```sh
$ bunzip2 enwiki-pages-articles.xml.bz2 | xml_to_dict.py 2 | myscript.py
AccessibleComputing
Anarchism
AfghanistanHistory
...
```sh
$ bunzip2 enwiki-pages-articles.xml.bz2 | xml_to_dict.py 2 | gzip > enwiki.dicts.gz
```
...
```sh
$ sudo yum install python-xml_to_dict
```
...
```sh
$ sudo pacman -S python-xml_to_dict
```
...
```sh
$ sudo apt install python-xml_to_dict
```
...
```sh
# Python2
$ zypper in python2-xml_to_dict

# Python3
$ zypper in python3-xml_to_dict
```
